...
function PostForSaleByOwnerListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    uploadedFiles.forEach(file => {
      console.log("Appending file:", file);  // Vérifier le fichier ajouté
    ...
    Object.keys(formData).forEach(key => {
      if (key !== 'photos') {
        console.log(`Appending data: ${key} = ${formData[key]}`);  // Vérifier les données ajoutées
    ...
    try {
      ...
      // Indiquer que la soumission est terminée (que ce soit en cas de succès ou d'erreur)
            ...
            <div className="filter-row">
              <div className="management-section">
                ...
                <div className="checkbox-group">
                  ...
                  <label className="checkbox-option">
                    <input type="checkbox" name="management" value="managed" />
                    <span className="checkmark"></span>
                    Managed
                  </label>
                </div>
